...
from ..repositories.managers import (IngredientManager, BeverageManager, OrderManager,
                                     SizeManager)
from app.controllers.utils.order import calculate_ingredients_total_amount, calculate_beverages_total_amount
...
class OrderController(BaseController):
    ...
    def calculate_order_price(size_price: float, ingredients: list, beverages: list):
        ...
        beverages_total_price = calculate_beverages_total_amount(beverages)

        price = size_price + ingredients_total_price + beverages_total_price
